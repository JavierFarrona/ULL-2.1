...
bool operator==(const Language& language1, const Language& language2); /// Igualdad
...
Language operator*(const Language& language1, const int potencia); /// Potencia
Language operator^(const Language& language1, const Language& language2); /// Intersección
Language operator|(const Language& language1, const Language& language2); /// Unión
Language operator!(const Language& language1); /// Inversa
